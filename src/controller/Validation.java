...
public class Validation {
	...
	private static final String VALID_NAME_ADD_REGEX ="^[A-Za-z ]{1,30}$";
	private static final String VALID_POKEMONNAME_SEARCH_REGEX ="^[A-Za-z]{1,30}$";
	...
	public static boolean isValidPokemonNameForAdd(String Pokemon){
		Pattern PokemonNamePattern = Pattern.compile(VALID_NAME_ADD_REGEX);
